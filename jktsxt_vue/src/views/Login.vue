    ...
    <div id="app">
      <el-form :model="ruleForm" status-icon :rules="rules" size="large" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="密码" prop="password">
          <el-input type="password" prefix-icon="lock" v-model="ruleForm.password" autocomplete="off" show-password></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="success" @click="submitForm('ruleForm')" style="width: 150px">登 录</el-button>
          <el-button type="success" @click="resetForm('ruleForm')" style="width: 100px" >重 置</el-button>
        </el-form-item>
        <div style="display: flex; align-items: center; justify-content: flex-end">
          <el-link type="success" href="/#/register">立即注册</el-link>
        </div>
      </el-form>
    </div>
  </div>
